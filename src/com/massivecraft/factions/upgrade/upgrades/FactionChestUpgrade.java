...
public class FactionChestUpgrade extends Upgrade
{
   ...
   public void onUpgrade(Faction faction)
   {
      ...
      int size = Integer.parseInt(UpgradesManager.get().getUpgradeByName(MUpgrade.get().factionChestUpgrade.getUpgradeName()).getCurrentDescription()[faction.getLevel(MUpgrade.get().factionChestUpgrade.getUpgradeName()) - 1].split(" ")[0]);
