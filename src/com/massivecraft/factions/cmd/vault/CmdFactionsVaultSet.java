        ...
        for (int x = -3; x < 4; x++) {
            for (int z = -3; z < 4; z++) {
                for (int y = -3; y < 4; y++) {
                    ...
                    final double size = ps.asBukkitLocation().getWorld().getWorldBorder().getSize()/2;
                    if(ps.asBukkitLocation().getX() > size || ps.asBukkitLocation().getZ() > size) {
                        return false;
                    }
                    if(ps.asBukkitLocation().getY() > 256)return false;
