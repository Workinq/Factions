...
import com.massivecraft.factions.cmd.FactionsCommandHome;
...
public class CmdFactionsHome extends FactionsCommandHome
{
	...
	public void perform() throws MassiveException
	{
		...
		if (home == null)
		{
			this.msg("<b>%s <b>does not have a home.", faction.describeTo(msender, true));
			
			if (MPerm.getPermSethome().has(msender, faction, false))
			{
				this.msg("<i>You should:");
				message(CmdFactions.get().cmdFactionsSethome.getTemplate());
			}
