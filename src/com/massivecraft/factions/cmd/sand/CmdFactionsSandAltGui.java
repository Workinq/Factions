...
public class CmdFactionsSandAltGui extends FactionsCommand
{
    ...
    public Inventory getSandAltGui(Player player, MPlayer mplayer, Faction faction)
    {
        ...
        chestGui.setAction(10, new ActionSpawnSandAlt(faction, player, player.getLocation(), maxAlts));
        ...
        chestGui.setAction(19, new ActionUpdateSandAlts(faction, mplayer, false));
        ...
        chestGui.setAction(28, new ActionUpdateSandAlts(faction, mplayer, true));
        ...
        chestGui.setAction(37, new ActionDespawnSandAlt(faction, mplayer, null, false));
        ...
        if ( ! faction.getSandAlts().isEmpty() )
        {
            ...
            for (SandAlt sandAlt : faction.getSandAlts())
            {
                ...
                chestGui.setAction(altSlots[slot], new ActionEditSandAlt(sandAlt, faction, mplayer));
