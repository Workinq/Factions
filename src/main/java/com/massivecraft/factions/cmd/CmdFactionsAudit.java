...
import com.massivecraft.factions.cmd.type.TypeFactionOrAll;
...
public class CmdFactionsAudit extends FactionsCommand
{
	...
	{
		this.addAliases("audit", "log");
		this.addParameter(Parameter.getPage());
		this.addParameter(TypeFactionOrAll.get(), "faction|all", "you");
		this.addParameter(null, new TypeEnum<>(AuditCategory.class), "category", false);
		this.addParameter(null, TypeMPlayer.get(), "actor", false);
	...
	public void perform() throws MassiveException
	{
		...
		List<AuditEntry> entries = (faction == null)
			? AuditUtil.queryGlobal(category, actor, days)
			: AuditUtil.query(faction, category, actor, days);
