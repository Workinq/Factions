...
public class MUpgrade extends Entity<MUpgrade>
{
    ...
    public ConfUpgrade chunkAltUpgrade = new ConfUpgrade(Txt.parse("Chunk Alts"), Material.BEACON, 3, new String[]{"10 chunk alts in /f chunkalt", "15 chunk alts in /f chunkalt", "20 chunk alts in /f chunkalt"}, new String[]{"10 chunk alts in /f chunkalt", "15 chunk alts in /f chunkalt", "20 chunk alts in /f chunkalt"}, new Integer[]{500000, 1000000, 2000000});
    public transient List<AbstractUpgrade> upgrades = MUtil.list(new SpawnerRateUpgrade(), new CropGrowthUpgrade(), new FactionChestUpgrade(), new TNTStorageUpgrade(), new WarpUpgrade(), new PowerboostUpgrade(), new SandAltUpgrade(), new ChunkAltUpgrade());
