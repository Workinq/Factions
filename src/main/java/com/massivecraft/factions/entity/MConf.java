...
public class MConf extends Entity<MConf>
{
	...
	public boolean raidClaimsEnabled = true;
	...
	// The side length, in chunks, of the square region claimed inward from a world corner by /f claim corner.
	public int claimCornerSize = 8;
	...
	public ChatColor colorRaidClaim = ChatColor.YELLOW;
