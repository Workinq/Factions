...
public final class AuditUtil
{
    ...
    public static AuditEntry log(AuditCategory category, AuditAction action, CommandSender actor, Faction faction, String targetId, Map<String, String> details)
    {
    ...
    public static final class Details
    {
        ...
        public Details put(String key, String value)
        {
